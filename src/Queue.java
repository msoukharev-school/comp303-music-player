...
public class Queue {
     ...
     * @pre pItem!=null
     * MODIFICATIONS: return types boolean to indicate whether the item was removed from the queue
     * @return true if item removed; false otherwise
     */
    public boolean remove(Song pItem) {
        assert pItem!=null;
        return aSongElements.remove(pItem);
    }
}
